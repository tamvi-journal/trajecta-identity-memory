...
# Usage: powershell -ExecutionPolicy Bypass -File install\install.ps1 [-AgentProfile aux]
param([string]$AgentProfile = "aux")
...
if ($env:AGENT_MEMORY_CORE_PATH) { & $VPy -m pip install --quiet -e $env:AGENT_MEMORY_CORE_PATH }
